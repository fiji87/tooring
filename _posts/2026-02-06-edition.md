...
Per l’iscrizione è necessario che la scuola invii specifica domanda entro il 25 Aprile via mail all'indirizzo: [luigi.capuano@unipi.it](mailto:luigi.capuano@unipi.it), allegando il [modulo d'iscrizione](https://docs.google.com/spreadsheets/d/1i6JJ_tJW0TTbCSgLVXGYUiLz4fr6Nj0Cn2wpUg2V4fY/edit?usp=sharing).
